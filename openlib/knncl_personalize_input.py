...
from src.openlib.models.knncl.knncl import KNNCL
...
def train():
    ...
    path = 'outputs/KNN_'+model_name_or_path+'_'+dataset1+'_'+str(known_cls_ratio) + '_'+max_epoch+'.ckpt'
    model = KNNCL.load_from_checkpoint(path, num_classes=datamodule.num_classes, label=label_to_id)
    # print("model", model)
