...
config = {
    ...
    'model' : {
        ...
        'init_args':{
            ...
            'warmup_steps': 0.1,
            'freeze': False,
            'tsne_path': './tsne/K+1_'+model_name_or_path+'_'+dataset+'_'+str(known_cls_ratio)+'_'+max_epoch,
        }
    },
    'trainer' : {
        'accelerator': 'auto',
    ...
    'project' : {
        'path' : './csv/'+method+'_'+model_name_or_path+'_'+dataset+'_'+str(known_cls_ratio)+'_'+max_epoch+'.csv'
    }
}
