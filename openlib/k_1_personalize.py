...
import torch
from src.openlib.models.K_1_way.K_1_way import K_1_way
...
def train():
    ...
    path = 'outputs/K+1_'+model_name_or_path+'_'+dataset1+'_'+str(known_cls_ratio) +'_'+max_epoch+ '.ckpt'  # ckpt    
    model = K_1_way.load_from_checkpoint(path, num_classes=datamodule.num_classes, label=label_to_id)  # 마지막에 저장된 ckpt
